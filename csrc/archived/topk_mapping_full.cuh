// Archived: not included by any compiled TU. See csrc/archived/README.md.
// The full mapping header supporting LUT_CDF, QUANTILE, TRUNC8, SUBTRACT,
// ADAPTIVE_TAIL_WINDOW, TOPK_WINDOW and the auto-range/pivot/tail-window
// pre-pass infrastructure. Replaced by the lean element-wise-only header
// at csrc/topk_mapping.cuh for the remap-benchmark refactor.
#pragma once
#include <cuda_fp16.h>
#include <cuda_bf16.h>
#include <cstdint>
