...
class ModelRunner:
    ...
    def __init__(
        ...
        # [VORTEX HOOK] block granularity for vortex block-sparse attention.
    ...
    def init_kv_cache_configurator(self):
        self.kv_cache_configurator = KVCacheConfigurator(
            ...
            # [VORTEX HOOK] vortex's KV pool is compiled against the runner.
            model_runner=self,
        )
    ...
    def initialize(self):
        ...
        # [VORTEX HOOK] build sparse flow + register vortex attention backends
        # in this (spawned) worker. Returns None when sparsity is disabled.
