...
::
    ...
    python algorithm_scientist/research/capture_trace.py \\
        --model Qwen/Qwen3-1.7B --data examples/validation.jsonl \\
...
def main():
    ...
    ap.add_argument("--data", default="examples/validation.jsonl",
                    help="CHOOSE THIS to match the workload you're optimizing for "
                         "(attention is workload-dependent): e.g. examples/aime24.jsonl "
                         "for math reasoning, examples/validation.jsonl (RULER/NIAH) to "
