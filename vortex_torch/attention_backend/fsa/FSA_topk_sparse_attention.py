...
from ..nsa.topk_sparse_attention import (backward_sum_o_do,
                                         reorder_topk_idx,
...
def FSA_topk_sparse_attention_varlen(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    topk_idx: torch.Tensor,
    ...
    """FSA topk sparse attention with separate Q and K sequence lengths (for extend/prefill).
