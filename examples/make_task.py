...
::
    ...
    python examples/make_task.py --task aime26 --model Qwen/Qwen3-4B \\
        --output examples/aime26__qwen3_4b.jsonl

    # custom HF dataset:
    python examples/make_task.py --hf-repo math-ai/aime25 --split test \\
        --model Qwen/Qwen3-4B --output examples/my.jsonl

The companion runner consumes it via
``run_submission.py --data examples/<file>.jsonl --config <submission>.json``.
